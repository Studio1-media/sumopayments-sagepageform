<?php
     ...
     */
    class WC_Gateway_SUMO_Sagepay_Direct_AddOns extends WC_Gateway_SUMO_Sagepay_Direct {
        ...
        public function maybe_render_subscription_payment_method( $payment_method_to_display, $subscription ) {
            ...
            if( $token ) {
                $payment_method_to_display = sprintf( __( 'Via %s card ending in %s', 'sumopayments_sagepayform' ), $token->get_card_type(), $token->get_last4() );
            }
